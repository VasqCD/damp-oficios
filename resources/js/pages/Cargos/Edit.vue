...
const form = ref({
    ...
    nivel_jerarquico: props.cargo.nivel_jerarquico?.toString() || '',
...
function submit() {
    ...
    router.put(`/cargos/${props.cargo.id}`, form.value, {
        onError: (err) => {
            errors.value = err;
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-bold tracking-tight">Editar Cargo</h2>
                    <p class="text-muted-foreground">
                        Actualizar información del cargo policial
                    </p>
                </div>
                <Link href="/cargos">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Modifique los datos del cargo policial
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex justify-end gap-4">
                            ...
                            <Button type="submit" :disabled="processing">
                                {{ processing ? 'Actualizando...' : 'Actualizar Cargo' }}
                            </Button>
                        </div>
                    </form>
                </CardContent>
