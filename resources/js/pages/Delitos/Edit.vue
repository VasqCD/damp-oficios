...
const form = ref({
    nombre: props.delito.nombre,
    descripcion: props.delito.descripcion || '',
    activo: props.delito.activo,
});
...
function submit() {
    ...
    router.put(`/delitos/${props.delito.id}`, form.value, {
        onError: (err) => {
            errors.value = err;
...
<template>
    <Head title="Editar Delito" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-bold tracking-tight">Editar Delito</h2>
                    <p class="text-muted-foreground">
                        Actualizar información del tipo de delito
                    </p>
                </div>
                <Link href="/delitos">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Modifique los datos del delito
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex justify-end gap-4">
                            ...
                            <Button type="submit" :disabled="processing">
                                {{ processing ? 'Actualizando...' : 'Actualizar Delito' }}
                            </Button>
                        </div>
                    </form>
                </CardContent>
