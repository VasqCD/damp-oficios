...
const form = ref({
    ...
    grupo_delictivo: props.persona.grupo_delictivo || '',
    estructura_criminal: props.persona.estructura_criminal || '',
...
const fotoPreview = ref<string | null>(
    props.persona.foto ? `/storage/${props.persona.foto}` : null
);
...
function submit() {
    ...
    router.post(`/personas-registradas/${props.persona.id}`, {
        _method: 'PUT',
        ...form.value,
    }, {
        onError: (err) => {
...
<template>
    <Head title="Editar Persona Registrada" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-bold tracking-tight">Editar Persona Registrada</h2>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Modifique los datos de la persona registrada
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-sm text-muted-foreground">
                                        JPG, PNG o GIF (máx. 2MB). Dejar vacío para mantener la foto actual.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="flex justify-end gap-4">
                            ...
                            <Button type="submit" :disabled="processing">
                                {{ processing ? 'Actualizando...' : 'Actualizar Persona' }}
                            </Button>
                        </div>
                    </form>
                </CardContent>
