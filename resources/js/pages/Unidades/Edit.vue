...
const form = ref({
    institucion_id: props.unidad.institucion_id.toString(),
    nombre: props.unidad.nombre,
    ciudad: props.unidad.ciudad || '',
    departamento: props.unidad.departamento || '',
    activo: props.unidad.activo,
});
...
function submit() {
    ...
    router.put(`/unidades/${props.unidad.id}`, form.value, {
        onError: (err) => {
            errors.value = err;
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-bold tracking-tight">Editar Unidad</h2>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex justify-end gap-4">
                            ...
                            <Button type="submit" :disabled="processing">
                                {{ processing ? 'Actualizando...' : 'Actualizar Unidad' }}
                            </Button>
                        </div>
                    </form>
                </CardContent>
